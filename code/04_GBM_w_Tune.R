...
sortedGrid <- h2o.getGrid("GBM_depth_grid", sort_by="auc", decreasing = TRUE)    
sortedGrid
...
sortedGrid <- h2o.getGrid("GBM_grid", sort_by = "auc", decreasing = TRUE)    
GBM_w_Tune <- h2o.getModel(sortedGrid@model_ids[[1]])
# -----------------------------------------------------------------------------
